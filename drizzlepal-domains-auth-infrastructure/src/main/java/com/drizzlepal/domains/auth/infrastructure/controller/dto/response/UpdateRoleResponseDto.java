...
@Data
@Schema(name = "更新角色响应", description = "更新角色响应参数模型")
public class UpdateRoleResponseDto implements DomainControllerResponse<UpdateRoleResponse, UpdateRoleResponseDto> {
    ...
    @Override
    public UpdateRoleResponseDto fromApiResponse(UpdateRoleResponse apiResponse) {
